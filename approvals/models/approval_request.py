...
class ApprovalRequest(models.Model):
    ...
    request_status = fields.Selection([
        ('new', 'To Submit'),
        ('pending', 'Submitted'),
        ('Engineering', 'Engineering'),  # i add this field to first approval
        ('Manager', 'Manager'),  # i add this field for second approval
        ('approved', 'Approved'),
        ('refused', 'Refused'),
        ('cancel', 'Cancel'),
    ...
    def action_submit_to_engineering(self, approver=None):
        self._ensure_can_approve()
            ...
            for user in new_users:
                ...
                if current_approver and current_approver.required != required:
                    ...
                    sequence = (users_to_category_approver[
                                    user.id].sequence or 1000) if request.approver_sequence else 10
...
class ApprovalApprover(models.Model):
    ...
    status = fields.Selection([
        ('new', 'New'),
        ('pending', 'To Approve'),
        ('pending', 'Engineering'),  # i add this field to first approval
        ('pending', 'Manager'),  # i add this field for second approval
        ('waiting', 'Waiting'),
        ('approved', 'Approved'),
        ('refused', 'Refused'),
